...
# scat1 = scatter!(ax[5], Data.x, Data.y, color = lift(X-> reduce(vcat, SWC_daily_fill[X,:]), sl.value), markersize = 3, strokecolor = :black, strokewidth = 1, colormap = cgrad(:RdYlBu; categorical = true), colorrange = (0.35, 0.48));
